...
export function initSpecularButton(elementOrSelector, options = {}) {
  const btn = typeof elementOrSelector === 'string' ? document.querySelector(elementOrSelector) : elementOrSelector;
  if (!btn) return;
